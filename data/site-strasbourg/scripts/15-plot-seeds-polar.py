...
def plot_multiple_connectivity_radar(csv_files, target_seeds):
    ...
    output_dir = "/home/simi/simian-brain/visuals"

    os.makedirs(output_dir, exist_ok=True)
    output_file = os.path.join(output_dir, "radar_connectivity.svg")
    plt.savefig(output_file, format='svg')
    print(f"Saved flower-style stacked radar plot to {output_file}")
    plt.show()

files = [
    "/home/simi/simian-brain/FC/site-oxford/seed-to-LIP-connectivity/group_mean_correlation_subs-*_seed-to-LIP.csv",
    "/home/simi/simian-brain/FC/site-oxford/seed-to-FEF-connectivity/group_mean_correlation_subs-*_seed-to-FEF.csv"]
