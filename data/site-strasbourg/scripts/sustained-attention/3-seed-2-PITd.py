...
# ++ CONFIGURATION ++
BASE_DIR = "/Volumes/simians/simian-brain"
DATASET = "site-strasbourg"
FC_DIR = f"{BASE_DIR}/final-functional-connectivity-3mm/{DATASET}"
...
DERIVATIVES_DIR = os.path.join(BASE_DIR, f"data/{DATASET}/final-derivatives-3mm")
