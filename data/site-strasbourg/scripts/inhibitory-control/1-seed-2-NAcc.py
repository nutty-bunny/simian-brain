...
MASK_DIR = "/Users/similovesyou/Desktop/qts/simian-brain/masks/impulsivity"

SEED_NAMES = [
    # Top-down cognitive control (prefrontal sources)
    "OFC",                # Orbitofrontal - reward evaluation
    "thalamus",  
    "dorsal_striatum"
]
TARGET_SEED = "nucleus_accumbens"
OUTPUT_DIR = os.path.join(FC_DIR, f"seed-to-{TARGET_SEED}-connectivity")
DERIVATIVES_DIR = os.path.join(FC_DIR, "impulsivity-seed-2-seed-connectivity")
